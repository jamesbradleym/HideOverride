...
namespace HideOverride
{
    public class Function
    {
        ...
        private UrlModelStore<HideOverrideInputs> store;

        public async Task<HideOverrideOutputs> Handler(HideOverrideInputs args)
        {
            ...
            if(this.store == null)
            {
                this.store = new UrlModelStore<HideOverrideInputs>();
            }
            

            var l = new InvocationWrapper<HideOverrideInputs,HideOverrideOutputs> (store, HideOverride.Execute);
