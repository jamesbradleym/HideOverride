...
{
	/// <summary>
	/// Override metadata for AnOverrideOverride
	/// </summary>
	public partial class AnOverrideOverride : IOverride
	{
        public static string Name = "An Override";
	...
	public static class AnOverrideOverrideExtensions
    {
		/// <summary>
        /// Apply An Override edit overrides to a collection of existing elements
        /// </summary>
        /// <param name="overrideData">The An Override Overrides to apply</param>
        ...
        public static List<T> Apply<T>(
            this IList<AnOverrideOverride> overrideData,
            IEnumerable<T> existingElements,
            Func<T, AnOverrideIdentity, bool> identityMatch,
            Func<T, AnOverrideOverride, T> modifyElement) where T : Element
        {
        ...
        /// </summary>
        /// <param name="existingElements">A collection of existing elements to which to apply the overrides.</param>
        /// <param name="overrideData">The An Override Overrides to apply — typically `input.Overrides.AnOverride`</param>
        /// <param name="identityMatch">A function returning a boolean which indicates whether an element is a match for an override's identity.</param>
        /// <param name="modifyElement">A function to modify a matched element, returning the modified element.</param>
        /// <typeparam name="T">The element type this override applies to. Should match the type(s) in the override's context.</typeparam>
        /// <returns>A collection of elements, including unmodified and modified elements from the supplied collection.</returns>
        public static void ApplyOverrides<T>(
            ...
            IList<AnOverrideOverride> overrideData,
            Func<T, AnOverrideIdentity, bool> identityMatch,
            Func<T, AnOverrideOverride, T> modifyElement
            ) where T : Element
        {
        ...
        /// </summary>
        /// <param name="edits">The collection of edit overrides (Overrides.AnOverride)</param>
        /// <param name="additions">The collection of add overrides (Overrides.Additions.AnOverride)</param>
        /// <param name="removals">The collection of remove overrides (Overrides.Removals.AnOverride)</param>        /// <param name="identityMatch">A function returning a boolean which indicates whether an element is a match for an override's identity.</param>
        ...
        public static List<T> CreateElements<T>(
            this IList<AnOverrideOverride> edits,
            IList<AnOverrideOverrideAddition> additions,
            IList<AnOverrideOverrideRemoval> removals,            Func<AnOverrideOverrideAddition, T> createElement,
            Func<T, AnOverrideIdentity, bool> identityMatch,
            Func<T, AnOverrideOverride, T> modifyElement,
