...
{
	/// <summary>
	/// Override metadata for HidableOverrideOverride
	/// </summary>
	public partial class HidableOverrideOverride : IOverride
	{
        public static string Name = "Hidable Override";
	...
	public static class HidableOverrideOverrideExtensions
    {
		/// <summary>
        /// Apply Hidable Override edit overrides to a collection of existing elements
        /// </summary>
        /// <param name="overrideData">The Hidable Override Overrides to apply</param>
        ...
        public static List<T> Apply<T>(
            this IList<HidableOverrideOverride> overrideData,
            IEnumerable<T> existingElements,
            Func<T, HidableOverrideIdentity, bool> identityMatch,
            Func<T, HidableOverrideOverride, T> modifyElement) where T : Element
        {
        ...
        /// </summary>
        /// <param name="existingElements">A collection of existing elements to which to apply the overrides.</param>
        /// <param name="overrideData">The Hidable Override Overrides to apply — typically `input.Overrides.HidableOverride`</param>
        /// <param name="identityMatch">A function returning a boolean which indicates whether an element is a match for an override's identity.</param>
        /// <param name="modifyElement">A function to modify a matched element, returning the modified element.</param>
        /// <typeparam name="T">The element type this override applies to. Should match the type(s) in the override's context.</typeparam>
        /// <returns>A collection of elements, including unmodified and modified elements from the supplied collection.</returns>
        public static void ApplyOverrides<T>(
            ...
            IList<HidableOverrideOverride> overrideData,
            Func<T, HidableOverrideIdentity, bool> identityMatch,
            Func<T, HidableOverrideOverride, T> modifyElement
            ) where T : Element
        {
        ...
        /// </summary>
        /// <param name="edits">The collection of edit overrides (Overrides.HidableOverride)</param>
        /// <param name="additions">The collection of add overrides (Overrides.Additions.HidableOverride)</param>
        /// <param name="removals">The collection of remove overrides (Overrides.Removals.HidableOverride)</param>        /// <param name="identityMatch">A function returning a boolean which indicates whether an element is a match for an override's identity.</param>
        ...
        public static List<T> CreateElements<T>(
            this IList<HidableOverrideOverride> edits,
            IList<HidableOverrideOverrideAddition> additions,
            IList<HidableOverrideOverrideRemoval> removals,            Func<HidableOverrideOverrideAddition, T> createElement,
            Func<T, HidableOverrideIdentity, bool> identityMatch,
            Func<T, HidableOverrideOverride, T> modifyElement,
